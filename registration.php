...
<html lang="en">
  ...
  <body style="background: lightgray">
		<div class="row" >
		  ...
		  <div class="col-6 row justify-content-center align-items-center" style="color: red;">
		  	<h1>BLOOD FOR YOU</h1>
		  </div>
		  ...
		  <div class="col-5" style="margin-top: 50px">
			  ...
			  <?php if(isset($_SESSION['match_u_e']) ){?>
				...
				<div class="row justify-content-between align-items-center">
                <div class="form-outline mb-4">
				  	<label class="form-label" for="form2Example1" style="color: red;"><h3>User Name</h3></label>
				...
				<div class="row justify-content-between align-items-center">
                  ...
                  <!-- adress input -->
				  <div class="form-outline mb-4">
				  	<label class="form-label" for="form2Example1" style="color: red;"><h3>Address</h3></label>
				...
				<div class="row justify-content-between align-items-center">
				  <!-- bloodgroup input -->
				  <div class="form-outline mb-4">
				  	<label class="form-label" for="form2Example2" style="color: red;"><h3>Blood Group</h3></label>
				...
				<div class="row justify-content-between align-items-center">
				  <!-- donation area input -->
				  <div class="form-outline mb-4">
				  	<label class="form-label" for="form2Example2" style="color: red;"><h3>Donation Area</h3></label>
				    <input required type="text" id="form2Example2" class="form-control" name="area" />
				  </div>
				  <div class="form-outline mb-4">
				  	<label class="form-label" for="form2Example2" style="color: red;"><h3>Last Donation Date</h3></label>
