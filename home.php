...
$b_g=$details['blood_g'];
$sqlr="SELECT * FROM request WHERE area ='$d_area' AND blood_g='$b_g' AND user_id!='$u_id' ORDER BY id DESC";
...
//echo $result." ".$u_id;
 ...
 <div class="row">
     ...
     <div class="col-9">
        <?php if(!$can_donate){ ?>
            <h1 style="width: 100%; text-align: center; color: red;">You are not eligible for donation</h1>
