...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2022 at 10:10 AM
...
(1, 'A+', 'Dhanmondi', 2, '2022-08-30', 1, 1),
(2, 'B-', 'Mirpur', 1, '2022-08-30', 0, 6),
(3, 'A+', 'Mirpur', 1, '2022-09-13', 0, 1),
(4, 'a+', 'Mirpur', 2, '2022-09-13', 0, 14);
...
(1, 'a', '1', 1, 'Mirpur', 'A+', '01245353525', '2022-08-01', 'Mirpur'),
(2, 'b', '2', 2, 'Dhanmondi', 'B+', '0174444444', '2022-08-07', 'Dhanmondi'),
...
(8, 'h', '8', 8, 'Azimpur', 'A-', '0169834593', '2022-08-07', 'Dhanmondi'),
(9, 'i', '9', 9, 'Malibag', 'A+', '01946738107', '2022-10-06', 'Basabo'),
(10, 'j', '10', 10, 'Uttara', 'B-', '01638293793', '2022-10-12', 'Uttara'),
(11, 'sad', 'aa', 11, 'Mirpur', 'A+', '00000000000', NULL, 'Mirpur'),
(12, 'tisha', 'tasnia', 12, 'Jigatola', 'B+', '11111111111', NULL, 'Jigatola'),
(13, 'sadik', 'topu', 13, 'Mirpur', 'a+', '00000000000', NULL, 'Mirpur'),
(14, 'TT', 'aa', 14, 'Bogura', 'A+', '00000000001', NULL, 'Bogura');
