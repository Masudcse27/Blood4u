...
<html lang="en">
  ...
  <body style="background: lightgray">
		...
		<div class="row"  >
		  ...
		  <div class="col-7 row justify-content-center align-items-center " style="margin-top: 50px;height: 500px; background:linear-gradient(to right, #E33D48, #FF627E); color:white; " >
